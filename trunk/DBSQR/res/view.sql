...
into outfile 'd:/dbsqr/dbsqr/ds_triple'
...
select triple_ds, count(*) as freq 
into outfile 'd:/dbsqr/dbsqr/ds_objectProperty_freq'
fields terminated by ': '
from triple_table 
where triple_property_type = 2
group by triple_ds 
order by freq desc

select triple_ds, count(*) as freq 
into outfile 'd:/dbsqr/dbsqr/ds_dataProperty_freq'
fields terminated by ': '
from triple_table 
where triple_property_type = 1
group by triple_ds 
order by freq desc

-- entity	concept	ds	 
select entity_id, entity_uri, schema_uri, ds_name  
into outfile 'd:/dbsqr/dbsqr/entity_concept_ds'
fields terminated by '\t'
...
into outfile 'd:/dbsqr/dbsqr/objectProperty_freq_ds'
fields terminated by '\t'
from triple_table
where triple_property_type = 2
...
select triple_property, count(*) as freq, triple_ds
into outfile 'd:/dbsqr/dbsqr/dataProperty_freq_ds'
fields terminated by '\t'
from triple_table
where triple_property_type = 1
group by triple_property, triple_ds
